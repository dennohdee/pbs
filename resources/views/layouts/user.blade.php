...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>PBS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">PBS</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="mailto:denniskiprotich0@gmail.com">{{ config('app.name') }}</a>.</strong> All rights
    reserved.
  </footer>
